  ...
  nixosModule =
    ...
    }:
    {
      imports = [
        ...
        }
        {
          ...
          options.services.nginx.virtualHosts = lib.mkOption {
            type = lib.types.attrsOf (lib.types.submodule { config.acmeRoot = lib.mkDefault null; });
          };
        }
      ];
      ...
      security.acme.defaults = {
        ...
        '';
        credentialFiles = {
          DESEC_TOKEN_FILE = config.clan.core.vars.generators.acme-desec.files.token.path;
        };
      };
