{
  ...
  homeModule =
    ...
    {
      home.packages = builtins.attrValues { inherit (pkgs) wl-clipboard font-awesome; };
      ...
      wayland.windowManager.sway.config = {
        ...
        keybindings =
          ...
          in
          {
            ...
            "${mod}+Shift+Return" = "exec ${lib.getExe pkgs.alacritty} -o 'window.class.general=\"floating\"'";
