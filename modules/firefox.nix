{
  darwinModule =
    { pkgs, lib, ... }:
    {
      ...
      system.defaults.CustomUserPreferences."org.mozilla.firefox".EnterprisePoliciesEnabled = true;
      system.defaults.CustomUserPreferences."org.mozilla.firefox".DisableAppUpdate = true;
    };
  ...
  homeModule =
    ...
    in
    {
      home.activation.setDefaultBrowser = lib.mkIf (cfg.enable && hostPlatform.isDarwin) (
      ...
      programs.firefox.package = if hostPlatform.isDarwin then null else pkgs.firefox;
      ...
      preservation.directories = map (name: ".mozilla/firefox/${name}") (builtins.attrNames cfg.profiles);
    };
}
