{
  ...
  nixosModule =
    ...
    }:
    {
      ...
      services.tailscale.authKeyFile = config.clan.core.vars.generators.tailscale.files.auth-key.path;

      services.syncthing.dataDir = "/persist${config.users.users.${user}.home}/Sync";
