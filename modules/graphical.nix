...
in
{
  ...
  darwinModule =
    { pkgs, lib, ... }:
    {
      ...
      environment.systemPackages = builtins.attrValues { inherit (pkgs) alt-tab-macos raycast utm; };
  ...
  homeModule =
    ...
    in
    {
      ...
      programs.firefox.profiles.personal = {
        ...
        extensions.packages = config.programs.firefox.profiles.base.extensions.packages ++ [
