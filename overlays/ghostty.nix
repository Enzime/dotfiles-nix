self: super: {
  ghostty-bin = assert !super ? ghostty-bin;
    super.stdenvNoCC.mkDerivation (finalAttrs: {
      ...
      src = super.fetchurl {
        url =
          "https://release.files.ghostty.org/${finalAttrs.version}/Ghostty.dmg";
        hash = "sha256-ZOUUGI9UlZjxZtbctvjfKfMz6VTigXKikB6piKFPJkc=";
      };

      sourceRoot = ".";

      nativeBuildInputs = [ super._7zz super.makeBinaryWrapper ];
      ...
      */
      resourceDir =
        "${placeholder "out"}/Applications/Ghostty.app/Contents/Resources";
      postFixup = ''
