self: super: {
  joplin-desktop =
    assert builtins.compareVersions super.joplin-desktop.version "3.0.12" == -1;
    self.callPackage
    ({ lib, stdenv, appimageTools, fetchurl, makeWrapper, _7zz }:
      ...
      let
        ...
        src = fetchurl {
          ...
          sha256 = {
            x86_64-linux =
              "sha256-vMz+ZeBHP+9Ugy8KO8lbp8zqC8VHtf1TWw10YytQFSs=";
            x86_64-darwin =
              "sha256-XZN1jTv/FhJXuFxZ6D6h/vFMdKi84Z9UWfj2CrMgBBA=";
            aarch64-darwin =
              "sha256-lsODOBkZ4+x5D6Er2/paTzAMKZvqIBVkKrWHh5iRvrk=";
          }.${system} or throwSystem;
        };
