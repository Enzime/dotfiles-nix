self: super: {
  shutdown-menu = super.writeScript "shutdown-menu" ''
    ...
    ROFI_OPTIONS=(-width -18 -location 4 -hide-scrollbar -padding 5 -font "Sourcecode Pro Regular 10, FontAwesome 10")
    # Zenity options
    ...
    menu_confirm="Poweroff Reboot Hibernate Suspend Halt Logout"
